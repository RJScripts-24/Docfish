...
export function AuthForm() {
  return (
    <div className="w-full max-w-md">
      ...
      >
        {/* Social Login */}
        <button className="w-full py-3.5 bg-white border-2 border-black rounded-[6px] hover:bg-gray-50 transition-all flex items-center justify-center gap-3 font-bold text-gray-700 shadow-[4px_4px_0_#000] active:translate-x-[2px] active:translate-y-[2px] active:shadow-none mb-4">
        ...
        {/* Continue as Guest */}
        <Link to="/dashboard">
          <button className="df-btn-secondary w-full py-3.5 text-base shadow-[4px_4px_0_#000] active:translate-x-[2px] active:translate-y-[2px] active:shadow-none">
            Continue as Guest
          </button>
        </Link>
