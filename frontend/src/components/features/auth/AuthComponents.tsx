...
import { Mail, Lock, Eye, EyeOff, Building2, CheckCircle2, Fish } from 'lucide-react';
    ...
    <div className="w-full max-w-md">
      ...
      >
        ...
        <p className="text-gray-600">
          {isSignIn 
            ? 'Sign in to your Docfish account' 
            : 'Start automating document workflows with Docfish'}
        </p>
      </motion.div>
      ...
      >
        ...
        {/* Social Login */}
        <button className="w-full py-3 border-2 border-gray-200 rounded-xl hover:border-gray-300 hover:bg-gray-50 transition-all flex items-center justify-center gap-3 font-medium text-gray-700">
        ...
        {/* Continue as Guest */}
        <Link to="/dashboard">
          <button className="w-full mt-3 py-3 border-2 border-gray-200 rounded-xl hover:border-gray-300 hover:bg-gray-50 transition-all font-medium text-gray-700">
            Continue as Guest
          </button>
        </Link>
