...
import { UploadZone, FileListItem } from '../components/upload/UploadComponents';
...
export default function Upload() {
  ...
  const handleStartProcessing = () => {
    alert('Processing started! AI will extract and validate invoice data.');
  };
  ...
  return (
    <div className="flex min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      ...
      <div className="flex-1 lg:ml-64">
        ...
        <main className="p-4 sm:p-6 lg:p-8 xl:p-10 max-w-[1600px] mx-auto space-y-6 sm:space-y-8">
          {/* Page Header */}
